...
remove(TeensHours, YoungAdultsHours, AdultsHours, SeniorsHours, Hours)
```
...
ggmap(map1) + geom_point(aes(x=Long, y=Lat, colour = age_group), data = bikesbyage_age_by_station, alpha = .7, size = 2, show.legend = TRUE)
